            ...
            <AnimatePresence>
              {isLanguageOpen && (
                <>
                  ...
                  />
                  <motion.div
                    initial={{ opacity: 0, y: 10, scale: 0.96, x: desktopLanguageDropdownOffsetX }}
                    animate={{ opacity: 1, y: 0, scale: 1, x: desktopLanguageDropdownOffsetX }}
                    exit={{ opacity: 0, y: 10, scale: 0.96, x: desktopLanguageDropdownOffsetX }}
